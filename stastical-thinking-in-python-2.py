...
# Shift the samples
bd_1975_shifted = bd_1975 - np.mean(bd_1975) + np.mean(combined_mean)
bd_2012_shifted = bd_2012 - np.mean(bd_2012) + np.mean(combined_mean)
...
def draw_bs_pairs(x, y, func, size=1):
    """Perform pairs bootstrap for single statistics."""
