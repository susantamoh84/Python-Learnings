...
plt.subplot(2,1,2)
sns.swarmplot(x='cyl', y='hp', data=auto, orient='v', hue='origin')
...
plt.subplot(2, 2, 1)
mean_30 = pd.rolling_mean(aapl, window=30)
...
plt.subplot(2, 2, 2)
mean_75 = pd.rolling_mean(aapl, window=75)
...
plt.subplot(2, 2, 3)
plt.plot(pd.rolling_mean(aapl, window=125), 'magenta')
plt.plot(aapl, 'k-.')
plt.xticks(rotation=60)
...
plt.subplot(2, 2, 4)
plt.plot(pd.rolling_mean(aapl, window=250), 'cyan')
plt.plot(aapl, 'k-.')
plt.xticks(rotation=60)
