...
right_columns = election.loc[:, 'winner':]
...
$index doesn't support mutable operations
...
visitors_pivot = pd.pivot_table(users, values='visitors', index='weekday', columns='city')
